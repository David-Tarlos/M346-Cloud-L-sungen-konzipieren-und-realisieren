...
Da der ehrenwerte David Ausfälle vermeiden möchte, hat er mehrere Availability Zones ausgewählt. Dies erhöht die Kosten leicht, ist jedoch eine Sicherheitsmassnahme, die Ausfallrisiken minimiert.
...
Unterschied
CloudFormation: Baut die Infrastruktur (EC2, LoadBalancer, Sicherheitsgruppen, Netzwerke) automatisch auf – alles reproduzierbar.
Cloud-Init: Konfiguriert die Software auf einer EC2-Instanz beim Start (Pakete installieren, Skripte ausführen).
